def DtreeRule(df):
    ...
    for i in range(0,len(df)):
        ...
        if (df.iloc[i]['A9'] == 'f'):
            ...
            #Level 2 Right node 
            # # Post pruning, Accuracy is better
            # if(df.iloc[i]['A6'] == 'c'):
            #     p+=1
            #     if(df.iloc[i]['A16'] == '+'): #Check if prediction is correct
            #         tp+=1
            # elif(df.iloc[i]['A6'] == 'd' or df.iloc[i]['A6'] == 'cc' or df.iloc[i]['A6'] == 'i' or df.iloc[i]['A6'] == 'j' or df.iloc[i]['A6'] == 'k' or df.iloc[i]['A6'] == 'm' or df.iloc[i]['A6'] == 'r' or df.iloc[i]['A6'] == 'q' or df.iloc[i]['A6'] == 'w' or df.iloc[i]['A6'] == 'x' or df.iloc[i]['A6'] == 'e' or df.iloc[i]['A6'] == 'aa' or df.iloc[i]['A6'] == 'ff'):
            #     n+=1
