...
def findmaxgainLv2L(dataset):  
    ...
    X5L311=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X00XX'
    X5L312=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X01XX'
    X5L313=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X02XX'
    X5L314=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X03XX'
    X5L315=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X04XX'
    X5L316=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X05XX'
    X5L317=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X06XX'
    X5L318=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X07XX'
    X5L319=[]  #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X08XX'
    X5L3110=[] #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X09XX'
    X5L3111=[] #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X1XXX'
    X5L3112=[] #ข้อมูลสำหรับสร้าง level 3 ที่ A14 = 'X2XXX'


    for i in range(len(dataset)):
        if (dataset.iloc[i][13][1] == '0'): 
            if (dataset.iloc[i][13][2] == '0'): 
                X5L311.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '1'): 
                X5L312.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '2'): 
                X5L313.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '3'): 
                X5L314.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '4'): 
                X5L315.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '5'): 
                X5L316.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '6'): 
                X5L317.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '7'): 
                X5L318.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '8'): 
                X5L319.append(dataset.iloc[i])
            elif (dataset.iloc[i][13][2] == '9'): 
                X5L3110.append(dataset.iloc[i])
        elif (dataset.iloc[i][13][1] == '1' ): 
            X5L3111.append(dataset.iloc[i])
        elif (dataset.iloc[i][13][1] == '2' ): 
            X5L3112.append(dataset.iloc[i])


    crx5L11 = pd.DataFrame(X5L311)
    crx5L12 = pd.DataFrame(X5L312)
    crx5L13 = pd.DataFrame(X5L313)
    crx5L14 = pd.DataFrame(X5L314)
    crx5L15 = pd.DataFrame(X5L315)
    crx5L16 = pd.DataFrame(X5L316)
    crx5L17 = pd.DataFrame(X5L317)
    crx5L18 = pd.DataFrame(X5L318)
    crx5L19 = pd.DataFrame(X5L319)
    crx5L110 = pd.DataFrame(X5L3110)
    crx5L111 = pd.DataFrame(X5L3111)
    crx5L112 = pd.DataFrame(X5L3112)

    
    #write csv
    crx5L11.to_csv('data/lv3/crx3L1.csv', index=False, header=False)
    crx5L12.to_csv('data/lv3/crx3L2.csv', index=False, header=False)
    crx5L13.to_csv('data/lv3/crx3L3.csv', index=False, header=False)
    crx5L14.to_csv('data/lv3/crx3L4.csv', index=False, header=False)
    crx5L15.to_csv('data/lv3/crx3L5.csv', index=False, header=False)
    crx5L16.to_csv('data/lv3/crx3L6.csv', index=False, header=False)
    crx5L17.to_csv('data/lv3/crx3L7.csv', index=False, header=False)
    crx5L18.to_csv('data/lv3/crx3L8.csv', index=False, header=False)
    crx5L19.to_csv('data/lv3/crx3L9.csv', index=False, header=False)
    crx5L110.to_csv('data/lv3/crx3L10.csv', index=False, header=False)
    crx5L111.to_csv('data/lv3/crx3L11.csv', index=False, header=False)
    crx5L112.to_csv('data/lv3/crx3L12.csv', index=False, header=False)
